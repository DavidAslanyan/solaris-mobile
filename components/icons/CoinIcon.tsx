...
const CoinIcon = ({
  ...
  return (
    ...
    >
      <g>
        <path
          d="M313.281,186.359l-5.938-2.484c-9.781-4.141-19.953-6.219-30.219-6.219c-29.719,0-57.016,17.234-70.125,43.625
        ...
        />
        <path
          d="M256,64c105.859,0,192,86.125,192,192c0,105.859-86.141,192-192,192c-105.875,0-192-86.141-192-192
